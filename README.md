...
2. Actual code extracted — 10 points
3. Explanation (in the report) — 10 points
...
2. Write a program, using the syntax of whatever language you like, that produces different
behavior depending on whether pass-by-reference or pass-by-value-result is used in its
parameter passing.
